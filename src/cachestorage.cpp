...
static const std::vector<VCardInfo> vcards {
    {"John", "Doe", {"+758 435 321 34", "+758 435 321 35"}, "qrc:/mockavatars/johndoe.png"},
    {"Johnny", "Doyer", {"+585 522 123 12"}, "qrc:/mockavatars/johndoe.png"},
    {"Jenny", "Dose", {"+444 444 444 44", "+555 555 555 55", "+666 666 666 66"}, "qrc:/mockavatars/jennydoe.png"}
};
